    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-6 mb-5 mb-lg-0">
          <img class="h-32px mb-4" src="{{url("assets/images/logo-second.png")}}" alt="logo">
          ...
          <div class="d-flex flex-column flex-lg-row justify-content-end">
            <div class="d-flex flex-column me-140px mb-3 mb-lg-0">
              ...
              <ul class="list-unstyled">
                <li class="text-white"><a href="mailto:rajihkharissuha120701@gmail.com">rajihkharissuha120701@gmail.com</a></li>
              </ul>
            </div>
